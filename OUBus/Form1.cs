...
namespace OUBus
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=H:\OU_Bus\OUBus\OUBus\cafe.mdf;Integrated Security=True;Connect Timeout=30");
